...
DUET.FileListTilesView.prototype.bindEvents = function () {
    ...
    DUET.evtMgr.subscribe('messages-panel-showing.fileTileView messages-panel-hidden.fileTileView', self.arrangePreviews.bind(self));
    ...
    this.$downloadButton.on('click', function (e) {
        new DUET.Request({
            ...
            success:function (response) {
                ...
                iframe.src = DUET.options.server + 'invoices/download/' + response.data;
            }
        });
    });
...
DUET.RunningTimerView = function(taskModel){
    ...
    this.addTo({
        $anchor:DUET.headerViewInstance.$runningTimerSpace
    });
};
...
DUET.ArchiveProjectView = function (project) {
    ...
    DUET.confirm({
        ...
        message:'Are you sure you want to archive ' + project.name + '? This will remove it from the active projects list',
        actionName:'Archive project',
        callback:function () {
            DUET.panelTwo.panel.notify('Archiving project', false);
...
DUET.UnarchiveProjectView = function (project) {
    ...
    DUET.confirm({
        ...
        message:'Are you sure you want to move ' + project.name + ' to In Progress?',
